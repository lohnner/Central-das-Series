window.LIVROS_LONER_BOOKS = [
  {
    ...
    author: 'Machado de Assis', authorNationality: 'Brasileiro', year: 2016, originalYear: 1899, country: 'Brasil', publisher: 'Penguin-Companhia',
    ...
    about: 'Narrado por um protagonista de memória incerta, o livro convida o leitor a decidir quanto confiar em sua versão dos acontecimentos.',
    source: 'https://openlibrary.org/search?q=Dom+Casmurro+Machado+de+Assis'
  },
  {
    slug: 'memorias-postumas-de-bras-cubas', title: 'Memórias Póstumas de Brás Cubas', originalTitle: 'Memórias Póstumas de Brás Cubas',
    author: 'Machado de Assis', authorNationality: 'Brasileiro', year: 2014, originalYear: 1881, country: 'Brasil', publisher: 'Penguin-Companhia',
    ...
    about: 'Com capítulos curtos e uma conversa direta com o leitor, Machado reinventou o romance brasileiro e criou um narrador inesquecível.',
    source: 'https://openlibrary.org/search?q=Memorias+Postumas+de+Bras+Cubas'
  },
  {
    slug: 'o-cortico', title: 'O Cortiço', originalTitle: 'O Cortiço',
    author: 'Aluísio Azevedo', authorNationality: 'Brasileiro', year: 2016, originalYear: 1890, country: 'Brasil', publisher: 'Penguin-Companhia',
    ...
    about: 'O espaço coletivo funciona como personagem e revela as tensões sociais do Brasil do final do século XIX.',
    source: 'https://openlibrary.org/search?q=O+Cortico+Aluisio+Azevedo'
  },
  {
    slug: 'capitaes-da-areia', title: 'Capitães da Areia', originalTitle: 'Capitães da Areia',
    author: 'Jorge Amado', authorNationality: 'Brasileiro', year: 2008, originalYear: 1937, country: 'Brasil', publisher: 'Companhia das Letras',
  ...
  },
  {
    ...
    author: 'Clarice Lispector', authorNationality: 'Brasileira', year: 1998, originalYear: 1977, country: 'Brasil', publisher: 'Rocco',
    ...
    about: 'Último romance publicado em vida por Clarice Lispector, combina compaixão, ironia e reflexão sobre linguagem e existência.',
    source: 'https://openlibrary.org/search?q=A+Hora+da+Estrela+Clarice+Lispector'
  },
  {
    slug: 'vidas-secas', title: 'Vidas Secas', originalTitle: 'Vidas Secas',
    author: 'Graciliano Ramos', authorNationality: 'Brasileiro', year: 2019, originalYear: 1938, country: 'Brasil', publisher: 'Record',
    ...
    about: 'A linguagem precisa de Graciliano Ramos retrata a pobreza, o silêncio e a resistência de uma família submetida à aridez.',
    source: 'https://openlibrary.org/search?q=Vidas+Secas+Graciliano+Ramos'
  },
  {
    slug: 'grande-sertao-veredas', title: 'Grande Sertão: Veredas', originalTitle: 'Grande Sertão: Veredas',
    author: 'João Guimarães Rosa', authorNationality: 'Brasileiro', year: 2019, originalYear: 1956, country: 'Brasil', publisher: 'Companhia das Letras',
    ...
    about: 'Uma viagem pelo sertão e pela linguagem, em que aventura, filosofia e invenção verbal se tornam inseparáveis.',
    source: 'https://openlibrary.org/search?q=Grande+Sertao+Veredas'
  },
  {
  ...
  },
  {
    ...
    author: 'Itamar Vieira Junior', authorNationality: 'Brasileiro', year: 2019, originalYear: 2019, country: 'Brasil', publisher: 'Todavia',
    ...
    about: 'O romance acompanha vozes de uma família ligada ao campo e revela permanências históricas da escravidão no Brasil.',
    source: 'https://openlibrary.org/search?q=Torto+Arado+Itamar+Vieira+Junior'
  },
  {
    slug: 'quarto-de-despejo', title: 'Quarto de Despejo', originalTitle: 'Quarto de Despejo',
    author: 'Carolina Maria de Jesus', authorNationality: 'Brasileira', year: 2014, originalYear: 1960, country: 'Brasil', publisher: 'Ática',
    ...
    about: 'Um testemunho direto e literariamente poderoso sobre desigualdade, dignidade e sobrevivência na cidade de São Paulo.',
    source: 'https://openlibrary.org/search?q=Quarto+de+Despejo+Carolina+Maria+de+Jesus'
  },
  {
    slug: 'dois-irmaos', title: 'Dois Irmãos', originalTitle: 'Dois Irmãos',
    author: 'Milton Hatoum', authorNationality: 'Brasileiro', year: 2006, originalYear: 2000, country: 'Brasil', publisher: 'Companhia das Letras',
    ...
    about: 'Memória familiar, identidade e história amazônica se misturam em uma narrativa sobre afeto, ciúme e ruína.',
    source: 'https://openlibrary.org/search?q=Dois+Irmaos+Milton+Hatoum'
  },
  {
    slug: 'o-avesso-da-pele', title: 'O Avesso da Pele', originalTitle: 'O Avesso da Pele',
    author: 'Jeferson Tenório', authorNationality: 'Brasileiro', year: 2020, originalYear: 2020, country: 'Brasil', publisher: 'Companhia das Letras',
    ...
    about: 'Uma narrativa íntima sobre identidade, educação, violência e os afetos que sobrevivem mesmo depois da perda.',
    source: 'https://openlibrary.org/search?q=O+Avesso+da+Pele+Jeferson+Tenorio'
  },
  {
    slug: 'a-cabeca-do-santo', title: 'A Cabeça do Santo', originalTitle: 'A Cabeça do Santo',
    author: 'Socorro Acioli', authorNationality: 'Brasileira', year: 2014, originalYear: 2014, country: 'Brasil', publisher: 'Companhia das Letras',
    ...
    about: 'Humor, fé e afeto se encontram em uma fábula brasileira sobre uma cidade esquecida que volta a ganhar vida.',
    source: 'https://openlibrary.org/search?q=A+Cabeca+do+Santo+Socorro+Acioli'
  },
  {
    slug: 'tudo-e-rio', title: 'Tudo é Rio', originalTitle: 'Tudo é Rio',
    author: 'Carla Madeira', authorNationality: 'Brasileira', year: 2021, originalYear: 2014, country: 'Brasil', publisher: 'Record',
    ...
    about: 'Com prosa intensa e capítulos breves, o romance acompanha emoções que se movem e transformam como a correnteza de um rio.',
    source: 'https://openlibrary.org/search?q=Tudo+e+Rio+Carla+Madeira'
  },
  {
    slug: 'olhos-dagua', title: "Olhos d'Água", originalTitle: "Olhos d'Água",
    author: 'Conceição Evaristo', authorNationality: 'Brasileira', year: 2016, originalYear: 2014, country: 'Brasil', publisher: 'Pallas',
    ...
    about: 'A escrevivência de Conceição Evaristo dá força poética a personagens que enfrentam as desigualdades do cotidiano.',
    source: 'https://openlibrary.org/search?q=Olhos+d+Agua+Conceicao+Evaristo'
  },
  {
    slug: 'niketche', title: 'Niketche', originalTitle: 'Niketche: Uma História de Poligamia',
    author: 'Paulina Chiziane', authorNationality: 'Moçambicana', year: 2004, originalYear: 2002, country: 'Moçambique', publisher: 'Companhia das Letras',
    ...
    about: 'Publicado no Brasil em português, o romance usa humor e crítica para discutir casamento, tradição e autonomia feminina em Moçambique.',
    source: 'https://openlibrary.org/search?q=Niketche+Paulina+Chiziane'
  },
  {
    slug: 'ensaio-sobre-a-cegueira', title: 'Ensaio sobre a Cegueira', originalTitle: 'Ensaio sobre a Cegueira',
    author: 'José Saramago', authorNationality: 'Português', year: 2017, originalYear: 1995, country: 'Portugal', publisher: 'Companhia das Letras',
    ...
    about: 'Em edição brasileira, o romance de José Saramago investiga solidariedade, violência e responsabilidade coletiva.',
    source: 'https://openlibrary.org/search?q=Ensaio+sobre+a+Cegueira+Jose+Saramago'
  },
  {
    slug: 'o-ateneu', title: 'O Ateneu', originalTitle: 'O Ateneu',
    author: 'Raul Pompeia', authorNationality: 'Brasileiro', year: 2005, originalYear: 1888, country: 'Brasil', publisher: 'Moderna',
    ...
    about: 'O romance combina memória e crítica social para retratar o colégio como uma miniatura do mundo adulto.',
    source: 'https://openlibrary.org/search?q=O+Ateneu+Raul+Pompeia'
  },
  {
    slug: 'a-metamorfose', title: 'A Metamorfose', originalTitle: 'Die Verwandlung',
    author: 'Franz Kafka', authorNationality: 'Tcheco', year: 1997, originalYear: 1915, country: 'Alemanha', publisher: 'Companhia das Letras',
    ...
    about: 'A edição brasileira apresenta uma das narrativas mais influentes do século XX, traduzida do alemão para o português.',
    source: 'https://openlibrary.org/search?q=A+Metamorfose+Franz+Kafka'
  },
  {
    slug: 'o-pequeno-principe', title: 'O Pequeno Príncipe', originalTitle: 'Le Petit Prince',
    author: 'Antoine de Saint-Exupéry', authorNationality: 'Francês', year: 2018, originalYear: 1943, country: 'França', publisher: 'HarperCollins Brasil',
    ...
    about: 'Traduzida para o português e publicada no Brasil, a fábula continua encantando leitores de todas as idades.',
    source: 'https://openlibrary.org/search?q=O+Pequeno+Principe+Saint+Exupery'
  }
];
...
(() => {
  ...
  if (detail) {
    ...
    setText('[data-detail-author-nationality]', book.authorNationality);
    ...
    setText('[data-detail-pages]', book.pages);
    setText('[data-detail-isbn]', `Copiar ISBN ${book.isbn}`);
    setText('[data-breadcrumb-title]', book.title);
    const cover = document.querySelector('[data-detail-cover]');
    cover.src = coverSrc(book.cover); cover.alt = `Capa de ${book.title}`;
    const source = document.querySelector('[data-detail-source]'); source.href = book.source;
    const isbn = document.querySelector('[data-detail-isbn]'); isbn.dataset.copyIsbn = book.isbn;
    const tracker = document.querySelector('[data-reading-tracker]');
    tracker.dataset.bookId = book.slug; tracker.dataset.bookTitle = book.title; tracker.dataset.bookSlug = book.slug;
    tracker.dataset.bookCover = `assets/images/livros/${book.cover}`; tracker.dataset.totalPages = book.pages;
    const pages = document.querySelector('[data-pages-read]'); pages.max = book.pages;
    setText('[data-reading-label]', `0 de ${book.pages} páginas · 0 XP`);
  }
})();
